...
const stagingProofRoutes = require("./routes/stagingProofRoutes");
const demoRoutes = require("./routes/demoRoutes");
const publicRoutes = require("./routes/publicRoutes");
const socialRoutes = require("./routes/socialRoutes");
const contentCalendarRoutes = require("./routes/contentCalendarRoutes");
const voiceContentRoutes = require("./routes/voiceContentRoutes");
...
const echoAssistantRoutes = require("./routes/echoAssistantRoutes");
const echoEmailRoutes = require("./routes/echoEmailRoutes");
...
app.use("/api/staging-proof", stagingProofRoutes);
app.use("/api/demo", demoRoutes);
app.use("/api/public", publicRoutes);
app.use("/api/social", socialRoutes);
app.use("/api/content-calendar", contentCalendarRoutes);
app.use("/api/voice-content", voiceContentRoutes);
...
app.use("/api/echo-assistant", echoAssistantRoutes);
