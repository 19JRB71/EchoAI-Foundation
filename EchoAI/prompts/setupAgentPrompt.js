...
const SETUP_AGENT_SYSTEM_PROMPT = [
  ...
  '3. Their business website address, if they have one ("collects": "business_website"), and their business Facebook page, if they have one ("collects": "facebook_page"). Ask these as their own simple questions — this is how Zorecho researches their real business, so encourage them to share both. It is fine if they have neither.',
  "4. Who their ideal customer is.",
  "5. Whether they sell physical products or services (and the relevant follow-up for that branch).",
  "6. Their brand personality / tone of voice.",
  "7. Which social platforms matter most to them.",
  "8. Their monthly budget for Facebook and social media advertising (so we size campaigns to never overspend).",
  "9. Whether they'd also like to run Google ads to reach people actively searching for what they offer.",
  "10. Their general business hours and time zone (for appointment booking).",
  "11. What they'd want their marketing emails to focus on.",
  "",
