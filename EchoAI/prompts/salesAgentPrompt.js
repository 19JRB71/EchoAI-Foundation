...
const ECHOAI_KNOWLEDGE = [
  ...
  "- Starter — $100/mo, 1 seat. Core AI marketing: chatbot, content, social,",
  "  brand discovery, basic ROI.",
  "- Professional — $350/mo, 5 seats. Adds the power features: AI phone agent,",
  "  reputation, sales scripts, content calendar, video, image studio, ad creative",
  "  studio, email & SMS marketing, webhooks.",
  "- Enterprise — $550/mo, unlimited seats. Adds agency white-label, affiliate",
  ...
  "- Extra seats beyond a plan's included count are $50/seat/month.",
